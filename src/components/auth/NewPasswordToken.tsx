...
export default function NewPasswordToken({ token, setToken, setValidate }: NewPasswordTokenProps) {
    ...
    return (
        <>
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                <Link to='/acceso/olvide-contrasena' className="text-center text-gray-300 font-normal">Solicitar un nuevo Código</Link>
            </nav>
        </>
    )
}