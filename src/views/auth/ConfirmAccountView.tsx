...
export default function ConfirmAccountView() {
    const [, setToken] = useState<ConfirmToken['token']>('')
    ...
    return (
        <>
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                <Link to='/acceso/nueva-contrasena' className="text-center text-gray-300 font-normal">Solicitar un nuevo Código</Link>
            </nav>
        </>
    )
}