    ...
    return (
        <>
            ...
            <p className="text-2xl font-light text-white mt-5">
                ...
                <span className=" text-violet-500 font-bold"> un nuevo código</span>
            </p>
            ...
            >
                ...
                <input
                    type="submit"
                    value='Enviar Código'
                    className="bg-violet-600 hover:bg-violet-700 w-full p-3 rounded-lg text-white font-black  text-xl cursor-pointer"
                />
            </form>
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                ...
                <Link to='/acceso/olvide-contrasena' className="text-center text-gray-300 font-normal">¿Olvidaste tu contraseña? restablecer</Link>
            </nav>
        </>
    )
}